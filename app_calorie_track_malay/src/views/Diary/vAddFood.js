                ...
                <View style = {styles.formView} >
                    <ScrollView style = {{flex : 1, width : '100%'}} >
                        ...
                        <View style = {styles.nutri_info}>
                            <Text style = {styles.subjectTxt}>Nutrition info</Text>
                            <View style = {styles.nutri_chart}>
                                <View style = {styles.nutri_piechart}>
                                    <Pie radius={60} innerRadius={40}
                                ...
                                <View style = {styles.nutri_chart_info}>
                                    {
                                        ...
                                        <View style = {styles.nutri_item_info}>
                                            <ColorIndicator color={item.color}/>
                                            <Text style = {styles.fs_14, {margin : 12, color : constant.C_BLACK_100, flex : 1}}>{item.name}</Text>
                                            <Text style = {styles.fs_14, {margin : 12, color : constant.C_BLACK_60}}>{item.w}</Text>
                                            <Text style = {[styles.fs_14, {color : constant.C_BLUE_50}]}>%{item.percentage}</Text>
                                        </View>
                                        )
                                    }
                                </View>
