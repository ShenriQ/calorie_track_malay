                ...
                <View style={styles.header}>
                    ...
                    <View style={styles.headerTab}>
                        <TouchableOpacity
                            ...
                            <Text style={[styles.fs_12, { color: this.state.activeTab == 0 ? constant.C_BLACK_0 : constant.C_BLACK_60 }]}>{Strings["Food"]}</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            activeOpacity={0.7}
                            style={[styles.headerTabBtn, this.state.activeTab == 1 ? styles.activeTabBtn : {}]}
                            onPress={() => this.setState({ activeTab: 1 })}>
                            <Text style={[styles.fs_12, { color: this.state.activeTab == 1 ? constant.C_BLACK_0 : constant.C_BLACK_60 }]} >{Strings["Exercise"]}</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ width: 20 }}>
                    </View>
