...
//svg
import Svg16 from '../../assets/svgs/auth/16.svg'

class vQ11 extends React.Component {
    constructor(props) {
        super(props);
        this.props = props;
        this.state = {
        ...
        return (
            <React.Fragment>
                ...
                <ScrollView style={styles.container}>
                    <Spacing height={70} />
                    <Stepper index={13} />
                    <Svg16 width={'100%'} height={287} style={styles.img}/>
...
export default connect(null)(vQ11)